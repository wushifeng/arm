        ...
        */
        ...
        if (videoIn->getPict)
        {
            ...
            case V4L2_PIX_FMT_MJPEG:
                get_picture(videoIn->tmpbuffer,videoIn->buf.bytesused, &pic_name);
		
		*ret_name = (char*)malloc(sizeof(pic_name)+20);
		memset(*ret_name, 0, sizeof(pic_name));
		strcpy(*ret_name,pic_name);
...
void init_framebuffer(void)
{
   ...
   // screensize = vinfo.xres * vinfo.yres * vinfo.bits_per_pixel / 8;
    screensize = 160 * 120 * vinfo.bits_per_pixel / 8;
